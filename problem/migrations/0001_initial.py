# Generated by Django 3.0.6 on 2020-05-07 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('samples', django_mysql.models.JSONField(default=dict, verbose_name='测试样例')),
                ('time_limit', models.IntegerField(default=1000, help_text='ms', verbose_name='时间限制')),
                ('memory_limit', models.IntegerField(default=65536, help_text='KB', verbose_name='内存限制')),
                ('difficulty', models.IntegerField(choices=[(1, 'Low'), (2, 'Mid'), (3, 'High')], verbose_name='难度')),
                ('languages', django_mysql.models.JSONField(default=dict, verbose_name='编程语言')),
                ...
                ('test_case_scores', django_mysql.models.JSONField(default=dict, verbose_name='测试点')),
                ...
                ('statistic_info', django_mysql.models.JSONField(default=dict, verbose_name='统计信息')),
